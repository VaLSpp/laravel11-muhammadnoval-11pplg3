    ...
    <header class="absolute top-0 left-0 z-10 flex w-full items-center bg-transparent">
        <div class="container">
            <div class="relative flex items-center justify-between">
                <div class="px-4">
                    <a href="#home" class="block py-6 text-lg font-bold text-primary">threeck</a>
                </div>
                <div class="flex items-center px-4">
                    ...
                    <nav id="nav-menu" class="absolute right-4 top-full hidden w-full max-w-[250px] rounded-lg bg-white py-5 shadow-lg dark:bg-dark dark:shadow-slate-500 lg:static lg:block lg:max-w-full lg:rounded-none lg:bg-transparent lg:shadow-none lg:dark:bg-transparent">
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <a href="#sertifikat" class="mx-8 flex py-2 text-base text-dark group-hover:text-primary dark:text-white">Sertifikat</a>
                            </li>
                            <li class="group">
            ...
            <div class="flex flex-wrap justify-center gap-y-4">
                <div class="w-full self-center px-4 lg:w-1/2">
                    <h1 class="text-base font-semibold text-primary md:text-xl">
                        Halo Semua 👋, kami <span class="mt-1 block text-4xl font-bold text-dark dark:text-white lg:text-5xl">THREECK</span>
                    </h1>
                    <h2 class="mb-3 text-lg font-medium text-secondary lg:text-2xl">
                        Sekumpulan <span class="font-bold text-dark dark:text-white">Web Developer</span> Pemula.
                    </h2>
                    <p class="mb-10 font-medium leading-relaxed text-secondary">
                        Belajar web programming itu mudah dan <span class="font-bold text-dark dark:text-white">menyenangkan</span> bukan?
                    </p>
                    <a href="#" class="rounded-full bg-primary py-3 px-8 text-base font-semibold text-white transition duration-300 ease-in-out hover:opacity-80 hover:shadow-lg">
                        Hubungi Saya
                    </a>
                </div>
                <div class="w-full self-end px-4 lg:w-1/2">
                    <div class="relative mt-10 lg:right-0 lg:mt-9">
                        <img src="{{ asset('/img/sandhika.png') }}" alt="Sandhika Galih" class="relative z-10 mx-auto max-w-full" />
            ...
            <div class="flex flex-wrap">
                <div class="mb-10 w-full px-4 lg:w-1/2">
                    ...
                    <p class="max-w-xl text-base font-medium text-secondary lg:text-lg">
                        ...
                        maiores sequi vitae saepe iusto deleniti!
                    </p>
                </div>
                <div class="w-full px-4 lg:w-1/2">
                    ...
                    <p class="mb-6 text-base font-medium text-secondary lg:text-lg">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus quos, hic animi quasi ipsum
                        exercitationem ipsam incidunt voluptatem.
                    </p>
                    <div class="flex items-center">
                        <!-- Youtube -->
                        <a href="https://youtube.com/webprogrammingunpas" target="_blank" class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
        ...
        <div class="container">
            <div class="w-full px-4">
                <div class="mx-auto mb-16 max-w-xl text-center">
                    ...
                    <h2 class="mb-4 text-3xl font-bold text-dark dark:text-white sm:text-4xl lg:text-5xl">Project Kami</h2>
                    <p class="text-md font-medium text-secondary md:text-lg">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatibus porro consequuntur alias,
                        commodi nemo enim aliquam ipsam obcaecati? Assumenda, ipsam?
                    </p>
                </div>
            </div>
            ...
            <div class="flex w-full flex-wrap justify-center px-4 xl:mx-auto xl:w-10/12">
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="overflow-hidden rounded-md shadow-md">
                        <img src="{{ asset('/img/portfolio/1.png') }}" alt="Landing Page" width="w-full" />
                    </div>
                    ...
                    <p class="text-base font-medium text-secondary">
                        ...
                        elit. Eius, iusto! Aliquam, corporis.
                    </p>
                </div>
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="overflow-hidden rounded-md shadow-md">
                        <img src="{{ asset('/img/portfolio/2.png') }}" alt="E-Commerce" width="w-full" />
                    </div>
                ...
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="overflow-hidden rounded-md shadow-md">
                        <img src="{{ asset('/img/portfolio/3.png') }}" alt="Technical Documentation" width="w-full" />
                    </div>
                ...
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="overflow-hidden rounded-md shadow-md">
                        <img src="{{ asset('/img/portfolio/4.png') }}" alt="Tribute Page" width="w-full" />
                    </div>
        ...
        <div class="container">
            <div class="w-full px-4">
                <div class="mx-auto mb-16 text-center">
                    <h4 class="mb-2 text-lg font-semibold text-primary">Sertifikat</h4>
                    <h2 class="mb-4 text-3xl font-bold text-white dark:text-dark sm:text-4xl lg:text-5xl">
                        Yang Pernah Kami Dapakan
                    </h2>
                    <p class="text-md font-medium text-secondary md:text-lg">
                        Lorem ipsum dolor sit amet consectetur
                        adipisicing elit. Vero suscipit facilis velit!
                    </p>
                </div>
            </div>
            ...
            <div class="flex w-full flex-wrap justify-center px-4 xl:mx-auto xl:w-10/12">
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="overflow-hidden rounded-md shadow-md">
                        <img src="{{ asset('/img/portfolio/1.png') }}" alt="Dicoding Web Development" width="w-full" />
                    </div>
                    <h3 class="mt-5 mb-3 text-xl font-semibold text-white dark:text-dark">Dicoding Web Development</h3>
                    <p class="text-base font-medium text-secondary">
                        Lorem ipsum dolor sit amet, consectetur adipisicing
                        elit. Eius, iusto! Aliquam, corporis.
                    </p>
                ...
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="overflow-hidden rounded-md shadow-md">
                        <img src="{{ asset('/img/portfolio/2.png') }}" alt="SMKCoding" width="w-full" />
                    </div>
                    <h3 class="mt-5 mb-3 text-xl font-semibold text-white1 dark:text-dark">SMKCoding</h3>
                    <p class="text-base font-medium text-secondary">
                        Lorem ipsum dolor sit amet, consectetur adipisicing
                        elit. Eius, iusto! Aliquam, corporis.
                    </p>
        ...
        <div class="container">
            <div class="w-full px-4">
                <div class="mx-auto mb-16 max-w-xl text-center">
                    ...
                    <h2 class="mb-4 text-3xl font-bold text-dark dark:text-white sm:text-4xl lg:text-5xl">Hubungi Kami
                    </h2>
                    <p class="text-md font-medium text-secondary md:text-lg">Lorem ipsum dolor, sit amet consectetur
                        adipisicing elit. Blanditiis, sed.</p>
                </div>
            </div>
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="mb-12 w-full px-4 font-medium text-slate-300 md:w-1/3">
                    <h2 class="mb-5 text-4xl font-bold text-white">THREECK</h2>
                    <h3 class="mb-2 text-2xl font-bold">Hubungi Kami</h3>
                    <p>threeck@gmail.com</p>
                ...
                <div class="mb-12 w-full px-4 md:w-1/3">
                    ...
                    <ul class="text-slate-300">
                        ...
                        <li>
                            <a href="#sertifikat" class="mb-3 inline-block text-base hover:text-primary">Sertifikat</a>
                        </li>
                        <li>
            ...
            <div class="w-full border-t border-slate-700 pt-10">
                ...
                <p class="text-center text-xs font-medium text-slate-500">
                    Dibuat dengan <span class="text-pink-500">❤️</span> oleh <a
                        href="https://instagram.com/sandhikagalih" target="_blank"
                        class="font-bold text-primary">threeck</a>, menggunakan
                    <a href="https://tailwindcss.com" target="_blank" class="font-bold text-sky-500">Tailwind
                        CSS</a>.
                </p>
            </div>
        </div>
